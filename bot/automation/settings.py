...
OPENAI_PLANNER_MAX_OUTPUT_TOKENS = int(
    os.getenv("OPENAI_PLANNER_MAX_OUTPUT_TOKENS", "3000")
)
OPENAI_CODE_MAX_OUTPUT_TOKENS = int(
    os.getenv("OPENAI_CODE_MAX_OUTPUT_TOKENS", "16000")
)
OPENAI_ANALYSIS_MAX_OUTPUT_TOKENS = int(
    os.getenv("OPENAI_ANALYSIS_MAX_OUTPUT_TOKENS", "4000")
)
OPENAI_RATE_LIMIT_RETRIES = int(
    os.getenv("OPENAI_RATE_LIMIT_RETRIES", "2")
)
OPENAI_RATE_LIMIT_SLEEP_SECONDS = float(
    os.getenv("OPENAI_RATE_LIMIT_SLEEP_SECONDS", "65")
)
